...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/Users/ahmedqamesh/Desktop/Master/HToGamma/SherpaResults/SherpaTrees/HTOGammaPDF-20-Sherpa.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/Users/ahmedqamesh/Desktop/Master/HToGamma/SherpaResults/SherpaTrees/HTOGammaPDF-20-Sherpa.root");
      }
