...
// Sun Nov 15 09:39:28 2015 by ROOT version 5.34/34
// from TTree tree/tr
// found on file: HTOGamma-Sherpa.root
//////////////////////////////////////////////////////////

#ifndef HToGammaSherpa_h
#define HToGammaSherpa_h
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
#include "TFile.h"
...
public :
   ...
   HToGammaSherpa(TTree *tree=0);
   virtual ~HToGammaSherpa();
   ...
   int GDau1=0,GDau2=0,REC=0,GEN=0;
	unsigned iGflag1 = -10,iGflag2 = -10;
	float Et2,Eta2,Phi2,En2,ID2,State2;
	float Et1,Eta1,Phi1,En1, ID1,State1;	
        float mRecoMass;
};

#endif
#ifdef HToGammaSherpa_cxx
HToGammaSherpa::HToGammaSherpa(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
     //      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/Users/ahmedqamesh/Desktop/Master/HToGamma/SherpaResults/SherpaCode/HTOGamma-Sherpa.root");
     // if (!f || !f->IsOpen()) {
     //  f = new TFile("/Users/ahmedqamesh/Desktop/Master/HToGamma/SherpaResults/SherpaCode/HTOGamma-Sherpa.root");
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("HTOGamma-Sherpa.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("HTOGamma-Sherpa.root");	 
      }
...
HToGammaSherpa::~HToGammaSherpa()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t HToGammaSherpa::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t HToGammaSherpa::LoadTree(Long64_t entry)
{
...
void HToGammaSherpa::Init(TTree *tree)
{
...
void HToGammaSherpa::Show(Long64_t entry)
{
...
Int_t HToGammaSherpa::Cut(Long64_t entry)
{
...
#endif // #ifdef HToGammaSherpa_cxx
